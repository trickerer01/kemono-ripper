...
from .filters import any_filter_matching_post_info, make_post_info_filters
...
async def _scan_posts_cached(kemono: Kemono, links: Iterable[PostPageScanResult], ls_results: Iterable[PCSDPost] = ()) -> list[PostInfo]:
