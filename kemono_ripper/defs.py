...
HELP_ARG_CACHE_SKIP = 'Always query API even if local cache was hit and is in sync with the remote source'
HELP_ARG_CACHE_FORCE = 'Never query API to prove local cache coherence'
